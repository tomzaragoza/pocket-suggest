Prediket.DashboardController = Ember.Controller.extend({
	myModalButtons: [
	...
	actions: {
		...
		//Cancel the modal, we don't need to hide the model 
		// manually because we set {..., dismiss: 'modal'} on the button meta data
		cancel: function() {
